...
public class Walker_walk_history_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_walker_walk_history);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    case R.id.walker_profile:
                        Intent resume = new Intent(Walker_walk_history_Activity.this,Walker_profile_Activity.class);
                        resume.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                        startActivityIfNeeded(resume, 0);
                        overridePendingTransition(0,0);
                        return true;
                    case R.id.walker_accept_order:
                        Intent resume1 = new Intent(Walker_walk_history_Activity.this,Walker_Accept_Order_Activity.class);
